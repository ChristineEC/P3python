...
- [User experience](##ux)
    ...
    - [Developer objectives](###devobj)
- [Features](##features)
    - [Game introduction](###feat-intro)
    - [Personal greeting and game start](###feat-start)
    - [Validation of user input](###user-input)
...
- [Bugs](##Bugs)
    - [Solved bugs](###solved)
    - [Unsolved bugs - none](###unsolved)
- [Future features](##future)
- [Deployment](##deploy)
- [Credits and Acknowledgements](##creds)



## How to play the game <a name="how-to-play"></a>
...
### Developer objectives <a name="devobj"></a>
...
### Validation of user input <a name="user_input"></a>
...
### Game progression <a name="game_prog"></a>
...
### Game result <a name="game-result"></a>
...
### Play again <a name="play-again"></a>
...
### Unsolved bugs (none) <a name="unsolved"></a>
The developer is not aware of any unsolved bugs.
